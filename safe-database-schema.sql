-- Safe Database Schema for Mozarex SEO Dashboard
-- This script safely handles existing functions and tables
...
DROP FUNCTION IF EXISTS cleanup_expired_analyses();
...
-- Success message
SELECT 'Safe database schema created successfully! 1 Customer → Multiple Websites → Each Website has its own data.' as message;
